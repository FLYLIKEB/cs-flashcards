...
class QuestionBankMetadataTests(unittest.TestCase):
    ...
    def test_question_bank_scripts_populate_category_and_issuer_options_and_keywords(self):
        ...
        self.assertIn('function questionBankCategoryBreakdown(', QUESTION_BANK_JS)
        ...
        self.assertIn('function closeCategoryGuideDialog({restoreFocus = true} = {})', QUESTION_BANK_JS)
        self.assertIn('function handleOpenCategoryGuideDialogKeydown(', QUESTION_BANK_JS)
