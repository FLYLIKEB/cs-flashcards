...
class StaticFrontendTests(unittest.TestCase):
    ...
    def test_calendar_page_and_menu_links_are_present(self):
        ...
        self.assertIn('id="quickFilterBtn"', CALENDAR_HTML)
        self.assertIn('id="activeFilterTags"', CALENDAR_HTML)
        self.assertIn('id="filterResultCount"', CALENDAR_HTML)
        self.assertIn('id="resetInstitutionFiltersBtn"', CALENDAR_HTML)
        self.assertIn('data-quick-panel="filters"', CALENDAR_HTML)
        self.assertIn('data-quick-panel="events"', CALENDAR_HTML)
        self.assertIn('data-quick-panel="overview"', CALENDAR_HTML)
        self.assertIn('data-quick-panel="watch"', CALENDAR_HTML)
        self.assertIn('id="calendarSidebarToggleBtn"', CALENDAR_HTML)
        self.assertIn('id="calendarFeatureMenuBtn"', CALENDAR_HTML)
        self.assertIn('id="calendarSidebarMenu"', CALENDAR_HTML)
        self.assertIn('data-sidebar-panel-target="overview"', CALENDAR_HTML)
        self.assertIn('data-sidebar-panel="overview"', CALENDAR_HTML)
        self.assertIn('id="calendarSidebar"', CALENDAR_HTML)
        ...
        self.assertIn('function toggleCalendarSidebar(force = !calendarState.sidebarOpen)', CALENDAR_JS)
        self.assertIn('function toggleCalendarSidebarMenu(force = !calendarState.sidebarMenuOpen)', CALENDAR_JS)
        self.assertIn('function setActiveSidebarPanel(panelId', CALENDAR_JS)
        self.assertIn('function renderFilterOptions(containerId', CALENDAR_JS)
        self.assertIn("document.querySelectorAll('[data-quick-panel]')", CALENDAR_JS)
        ...
        self.assertIn('.calendar-sidebar-toggle', CALENDAR_CSS)
        self.assertIn('.calendar-sidebar-menu', CALENDAR_CSS)
        self.assertIn('.calendar-panel-tabs', CALENDAR_CSS)
        self.assertIn('.filter-option-grid', CALENDAR_CSS)
        self.assertIn('.filter-result-bar', CALENDAR_CSS)
        self.assertIn('.calendar-drawer', CALENDAR_CSS)
        self.assertIn('body.calendar-sidebar-collapsed .calendar-sidebar', CALENDAR_CSS)
